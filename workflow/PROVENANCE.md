...
Together, these checks reconstruct the 1,005 initial search assignments from the full GMO v1 proteome, rerun the shared PF01053 family resolution, and reproduce the complete manuscript-scope MEME/FIMO stage. They do not yet rerun expected-domain validation, the final gate, or expression mapping.
